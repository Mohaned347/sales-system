  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <aside className={`fixed inset-y-0 right-0 z-40 w-64 bg-white shadow-lg flex flex-col py-8 px-4 border-r border-gray-200 transform transition-transform duration-200 md:static md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} md:translate-x-0 md:relative md:flex overflow-y-auto`} style={{ maxHeight: '100vh' }}>
          <div className="flex items-center justify-between mb-8 md:hidden">
            <button onClick={() => setSidebarOpen(false)} className="text-gray-500 text-2xl"><FiX /></button>
            <h2 className="text-xl font-bold text-primary">لوحة الإدارة</h2>
            <span></span>
          </div>
          <h2 className="text-2xl font-bold mb-8 text-center text-primary hidden md:block">لوحة الإدارة</h2>
