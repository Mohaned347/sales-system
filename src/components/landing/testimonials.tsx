...
const testimonials = [
  {
    ...
    quote: '"لقد غير مبيعاتي طريقة عملنا تمامًا. أصبح تتبع المبيعات وإدارة المخزون أسهل من أي وقت مضى. أوصي به بشدة!"',
  ...
  },
  {
    ...
    quote: '"كصاحبة عمل صغير، كنت أبحث عن أداة شاملة وبأسعار معقولة. مبيعاتي قدم لي كل ما أحتاجه وأكثر. خدمة العملاء ممتازة أيضًا."',
    avatar: 'https://placehold.co/40x40.png',
    initials: 'فز'
  },
  {
